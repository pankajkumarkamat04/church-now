...
export default function AdminCouncilMembersPage() {
  ...
  const load = useCallback(async () => {
    ...
    const r = await apiFetch<Res>(`/api/admin/councils/${councilId}/members`, { token });
    setData(r);
  }, [token, councilId]);
  ...
  useEffect(() => {
    if (user?.role === 'ADMIN' && token && councilId) {
