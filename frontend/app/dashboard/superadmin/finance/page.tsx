  ...
  return (
    <div className="max-w-6xl">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-neutral-600">Platform-wide tithes, subscriptions, donations, and expenses.</p>
      </div>
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-xl border border-neutral-200 bg-white p-4 shadow-sm">
            ...
            <p className="mt-1 text-sm text-neutral-700">
              Tithes {summary.counts.tithes} · Subs {summary.counts.subscriptions} · Donations {summary.counts.donations} · Expenses{' '}
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <span className="mt-1 text-sm text-neutral-600">Filters and currency breakdown</span>
        ...
        >
          ...
          <span className="mt-1 text-sm text-neutral-600">All subscription payments</span>
          <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-violet-700">
            Open <ArrowRight className="size-3.5" />
          </span>
        </Link>
        ...
        >
          ...
          <span className="mt-1 text-sm text-neutral-600">Platform tithe records</span>
          <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-violet-700">
            Open <ArrowRight className="size-3.5" />
          </span>
        </Link>
        ...
        >
          ...
          <span className="mt-1 text-sm text-neutral-600">All donation records</span>
          <span className="mt-3 inline-flex items-center gap-1 text-xs font-medium text-violet-700">
            Open <ArrowRight className="size-3.5" />
          </span>
        </Link>
