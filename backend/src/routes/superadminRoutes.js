...
router.post(
  ...
  asyncHandler(systemSettingController.uploadSystemLogo)
);
...
router.get('/main-church/pastors-overview', asyncHandler(pastorController.listMainChurchPastorsOverview));
router.post('/pastors/unassign-local', asyncHandler(pastorController.unassignLocalSpiritualPastor));
router.post('/pastors/unassign', asyncHandler(pastorController.unassignPastorCompletely));
